...
REGISTER_HTML = """<!DOCTYPE html><html lang="en"><head><title>Register — SMS</title>""" + _BASE_STYLE + """</head><body>
  ...
  <div class="card">
    ...
    <div class="logo">
      ...
      <div>
        ...
        <div class="logo-sub">Vulnerable Registration</div>
      </div>
    ...
    <p class="subtitle">
      ...
      WARNING: Weak passwords accepted
